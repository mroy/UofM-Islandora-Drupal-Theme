...
<div id="container" class="clear-block"><!-- begin container -->
  <div class="shadow1">
	...
	<div id="header"><!-- begin header -->
  		<div id="logo"><a href="http://www.umanitoba.ca" title="University of Manitoba"><img src="<?php echo $base_url.'/'.$theme_path.'/images/umlogo_trans.gif';?>" id="umlogo"/></a>
		<a href="http://www.umanitoba.ca/libraries" title="Libraries"><img src="<?php echo $base_url.'/'.$theme_path.'/images/libraries_trans.gif';?>"/></a>
	...
	<div id="slogan-floater"><!-- begin slogan-floater -->
	    ...
	    <div id="utilityLinks"><a href=http://umanitoba.ca/>U of M Home</A> | <a href="http://umanitoba.ca/search/atoz.html">A-Z Index</a> | <a href="http://umanitoba.ca/maps/">Maps</a> | <a href="https://jump.umanitoba.ca/cp/login/">JUMP</a> | <a href="https://webware.cc.umanitoba.ca/webmail/horde/imp/alt-login/custom_login.php?Horde=cf6270703618e1eb20a2c0c83614a4d5">Webmail</a></div>    
	    <div id="search">
...
<span class="radio1"><input name="search_type" id="searchTypeBtn" value="local" checked="checked" type="radio" style="float:left;"></span>    <span style="float:left;display:inline;" id="text1">U of M Website</span>
